...
const os = require("os");
const { generatePDF } = require("../pdf_generator_pdfkit");
...
const exportRoteiroToPdf = async (req, res) => {
    ...
    try {
        ...
        // Usar a nova função de geração de PDF com PDFKit
        console.log('Gerando PDF com PDFKit...');
        try {
            const pdfBuffer = await generatePDF(roteiro);
            ...
            console.error("Erro ao gerar PDF com PDFKit:", pdfError);
